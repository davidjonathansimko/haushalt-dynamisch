...
import { CozyLivingScene } from "./CozyLivingScene"
import { SceneOverlay } from "./SceneOverlay"
import { isTouchDevice, RotateHint, Effects } from "./shared"

const COZY_ITEMS = [
  { key: "SOFA", priceEur: 1599 },
  { key: "SESSEL", priceEur: 649 },
  { key: "KISSEN", priceEur: 89 },
  { key: "COUCHTISCH", priceEur: 449 },
  { key: "BÜCHERREGAL", priceEur: 179 },
  { key: "STEHLAMPE", priceEur: 329 },
  { key: "VORHANG", priceEur: 159 },
  { key: "HEIZUNG", priceEur: 599 },
...
export function CozyLivingApp() {
  ...
  return (
    <>
      <RotateHint />
      <SceneOverlay items={COZY_ITEMS} hovered={hovered} roomId="cozy-living" />
      <Suspense fallback={<Loader />}>
        ...
        >
          ...
          <Bvh firstHitOnly>
            <Selection>
              <Effects roomId="cozy-living" />
              <CozyLivingScene rotation={[0, -Math.PI / 2 + 0.05, 0]} position={[0.4, -0.75, -0.3]} />
            </Selection>
          </Bvh>
        </Canvas>
      </Suspense>
