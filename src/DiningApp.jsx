...
const DINING_ITEMS = [
  { key: "ESSTISCH", priceEur: 1899 },
  { key: "STUHL", priceEur: 349 },
  { key: "TEPPICH", priceEur: 589 },
  { key: "BELEUCHTUNG", priceEur: 429 },
  { key: "BILD", priceEur: 199 },
  { key: "BLUMEN", priceEur: 65 },
  { key: "SCHRANK", priceEur: 1299 },
  { key: "FENSTER", priceEur: 799 },
]
...
export function DiningApp() {
  ...
  return (
    <>
      <RotateHint />
      <SceneOverlay items={DINING_ITEMS} hovered={hovered} roomId="dining" />
      <Suspense fallback={<Loader />}>
        <Canvas
          flat
          dpr={[1, isTouch ? 1 : 1.5]}
          gl={{ antialias: false, powerPreference: "high-performance" }}
          camera={{ position: [0, 1, 6], fov: isTouch ? (isLandscape ? 32 : 30) : 25, near: 1, far: 20 }}
        ...
        >
          ...
          <Bvh firstHitOnly>
            <Selection>
              <Effects roomId="dining" />
              <DiningScene rotation={[0, Math.PI / 2, 0]} position={[0, -1, -0.85]} />
            </Selection>
          </Bvh>
        </Canvas>
      </Suspense>
