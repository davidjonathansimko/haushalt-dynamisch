...
const itemNames = {
  de: {
    ...
    BADEWANNE: "BADEWANNE", WASCHBECKEN: "WASCHBECKEN", SPIEGEL: "SPIEGEL", DUSCHE: "DUSCHE",
    HANDTUCHHALTER: "HANDTUCHHALTER", PFLANZE: "PFLANZE",
  },
  en: {
    ...
    BADEWANNE: "BATHTUB", WASCHBECKEN: "SINK", SPIEGEL: "MIRROR", DUSCHE: "SHOWER",
    HANDTUCHHALTER: "TOWEL RACK", PFLANZE: "PLANT",
  },
  ro: {
    ...
    BADEWANNE: "CADĂ", WASCHBECKEN: "CHIUVETĂ", SPIEGEL: "OGLINDĂ", DUSCHE: "DUȘ",
    HANDTUCHHALTER: "SUPORT PROSOAPE", PFLANZE: "PLANTĂ",
  },
  ru: {
    ...
    BADEWANNE: "ВАННА", WASCHBECKEN: "РАКОВИНА", SPIEGEL: "ЗЕРКАЛО", DUSCHE: "ДУШ",
    HANDTUCHHALTER: "ВЕШАЛКА ДЛЯ ПОЛОТЕНЕЦ", PFLANZE: "РАСТЕНИЕ",
  },
}
...
const translations = {
  de: {
    ...
    bathroom: "Badezimmer",
    bathroomDesc: "Badewanne, Dusche, Waschbecken und stilvolles Design",
    defaultTitleBathroom: "BADEZIMMER",
  ...
  en: {
    ...
    bathroom: "Bathroom",
    bathroomDesc: "Bathtub, shower, sink and stylish design",
    defaultTitleBathroom: "BATHROOM",
    room1: "Room",
    dining: "Dining Room Kitchen",
    diningDesc: "Dining table, chairs, lighting and stylish decoration",
  ...
  ro: {
    ...
    bathroom: "Baie",
    bathroomDesc: "Cadă, duș, chiuvetă și design elegant",
    defaultTitleBathroom: "BAIE",
    room1: "Cameră",
    dining: "Dining Room Kitchen",
    diningDesc: "Masă de dining, scaune, iluminat și decorațiuni elegante",
  ...
  ru: {
    ...
    bathroomDesc: "Ванна, душ, раковина и стильный дизайн",
    defaultTitleBathroom: "ВАННАЯ",
    room1: "Комната",
    dining: "Dining Room Kitchen",
    diningDesc: "Обеденный стол, стулья, освещение и стильный декор",
